...
class tl_catalog extends Backend
{
    ...
    public function setCoreTableData(DataContainer $dc): void
    {
    ...
    protected function getTables($arrExclude = []): array
    {
    ...
    public function getPanelLayouts(): array
    {
        return ['filter', 'sort', 'search', 'limit'];
    }

    public function getOperations(DataContainer $dc): array
    {
    ...
    public function getModeTypes(DataContainer $dc): array
    {
    ...
    public function checkTablename($varValue, DataContainer $dc): string
    {
    ...
    public function getParentDataContainerFields(DataContainer $dc): array
    {
    ...
    public function getDataContainerFields(DataContainer $dc): array
    {
    ...
    public function getSystemTables(DataContainer $dc): array
    {
    ...
    public function getNavigationAreas(): array
    {

        $arrReturn = [];
        $arrModules = $GLOBALS['BE_MOD'] ?: [];
    ...
    public function getNavigationPosition(): array
    {
    ...
    public function getInternalCatalogFields(): array
    {
    ...
    public function getExternalCatalogFields(): array
    {
